...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center bg-slate-300 justify-evenly text-sm py-3 border-b border-b-gray-400'>
       <p onClick={()=> navigate('/')} className='w-44 text-xl font-bold text-primary cursor-pointer'>MediConnect</p>
